...
namespace CinemaAutomation.Controllers
{
    public class HomeController : Controller
    {
        ...
        public class homeController : Controller
        {
            ...
            public homeController(ILogger<homeController> logger, IRepository<Genre> genreRepository, IRepository<Movie> movieRepository)
            {
                _logger = logger;
            ...
            public IActionResult Index()
            {
                ...
                var movies = movieRepository.ActiveMovieGenreVMs();
                return View(movies);
            }
            ...
            {
                ViewBag.Genres = genreRepository.GetActive();
                var movies = genreRepository.GetMoviesByGenreId(id);
