    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalloonSeats", x => new { x.SalloonId, x.SeatId });
                    table.ForeignKey(
                        name: "FK_SalloonSeats_Salloons_SalloonId",
                        column: x => x.SalloonId,
                        principalTable: "Salloons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalloonSeats_Seats_SeatId",
                        column: x => x.SeatId,
